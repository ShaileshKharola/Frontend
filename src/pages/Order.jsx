          ...
          <div key={index} className='py-4 border-b text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
            <div className='flex items-start gap-6 text-sm'>
              ...
              <div>
                ...
                <p className='mt-2'>Date: <span className='text-gray-400'>3, JUNE 2025</span></p>
                </div>
            </div>
            <div className='md:w-1/2 flex justify-between'>
              <div className='flex items-center gap-2'>
                ...
                <button className='bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300'>Track Order</button>
            </div>
          </div>
        ))
      }
